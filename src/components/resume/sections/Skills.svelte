  ...
  let items = [
    ...
    },
    {
      ...
      tags: [{title: TagNames.PYTHON, order: 2, force_hide: false, use_index: true},
        ...
        {title: TagNames.TYPESCRIPT, order: 4, force_hide: false, use_index: true},
        {title: TagNames.GOLANG, order: 5, force_hide: false, use_index: true},
        {title: TagNames.CPP, order: 5, force_hide: false, use_index: true},
